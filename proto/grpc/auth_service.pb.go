...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xa7, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_auth_service_proto_goTypes = []interface{}{
	...
	(*SignUpUserResponse)(nil), // 2: intrvproto.SignUpUserResponse
	(*SignInUserResponse)(nil), // 3: intrvproto.SignInUserResponse
}
var file_auth_service_proto_depIdxs = []int32{
	...
	2, // 2: intrvproto.AuthService.SignUpUser:output_type -> intrvproto.SignUpUserResponse
	3, // 3: intrvproto.AuthService.SignInUser:output_type -> intrvproto.SignInUserResponse
